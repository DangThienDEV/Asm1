            ...
            <tbody>
                @foreach($users as $user)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('users.show', $user->id) }}" class="uk-button uk-button-default uk-button-small">View</a>
                            <a href="{{ route('users.edit', $user->id) }}" class="uk-button uk-button-warning uk-button-small">Edit</a>
